...
public class BaseTest {
	...
	// for Windows
	//public AppiumDriverLocalService getAppiumServerDefault() {return AppiumDriverLocalService.buildDefaultService();
	//}

	// for Mac. Update the paths as per your Mac setup
	public AppiumDriverLocalService getAppiumService() {
		HashMap<String, String> environment = new HashMap<String, String>();
		environment.put("PATH", "/opt/homebrew/bin/node" + System.getenv("PATH"));
		environment.put("ANDROID_HOME", "/Users/sunil/Library/Android/sdk");
